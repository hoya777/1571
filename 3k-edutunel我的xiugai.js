 ...
 */
let userID = '5588c4d1-43ea-4b6a-ba06-717564787856';

/**
 * Array of proxy server addresses with ports
 * Format: ['hostname:port', 'hostname:port']
 */
const proxyIPs = ['cdn.xn--b6gac.eu.org:443', 'cdn-all.xn--b6gac.eu.org:8443','ProxyIP.Oracle.CMLiussss.net:2087','ProxyIP.DigitalOcean.CMLiussss.net:','ProxyIP.Vultr.CMLiussss.net:2053','ProxyIP.Multacom.CMLiussss.net','kr.tp50000.netlib.re:2096'];
